...
// FakeChubaoFSClusters implements ChubaoFSClusterInterface
type FakeChubaoFSClusters struct {
...
func (c *FakeChubaoFSClusters) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(chubaofsclustersResource, c.ns, opts))
